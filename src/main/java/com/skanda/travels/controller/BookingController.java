...
public class BookingController {
  ...
  public BookingResponse cancelBooking(
      @AuthenticationPrincipal AuthenticatedUserDetails principal,
      @PathVariable String bookingReference) {
    return bookingService.cancelBooking(principal.getUser(), bookingReference);
  }

  @PatchMapping("/{bookingReference}/confirm")
  public BookingResponse confirmBooking(@PathVariable String bookingReference) {
  ...
  public void adminCancellation(@PathVariable Long tripId) {
      bookingService.adminCancellation(tripId);
  }
